...
###########################################################################################
  ...
  '''
  Here, I'm taking the coordinates and computing the center of the bounding box
  Then, I'm writing the coodinates value in the center of the bounding box.
  or, drawing a circle at the center.
  '''
  ...
  game.player_at_coords(CENTER_COORDINATES)

  # Coordinate text
  draw.text(CENTER_COORDINATES, f'{CENTER_COORDINATES}', fill=(255,255,0))
